...
const BY_PLACE = {
  Mexico: [
    ...
    'batanga', 'mezcal-negroni', 'mexican-mule', 'oaxaca-old-fashioned',
    'tequila-cruda', 'mezcal-y-naranja', 'bandera', 'tequila-slammer', 'brave-bull-shot',
  ],
  Cuba: [
  ...
  'United States': [
    ...
    'boston-sour', 'paper-plane', 'naked-and-famous', 'gold-rush', 'whiskey-smash', 'old-cuban', 'gibson', 'el-diablo', 'siesta', 'oaxaca-old-fashioned', 'navy-grog', 'three-dots-and-a-dash', 'fog-cutter', 'scorpion', 'adonis', 'sherry-cobbler', 'death-in-the-afternoon', 'affinity', 'kentucky-mule', 'gin-gin-mule', 'boilermaker', 'godmother', 'golden-dream', 'almond-joy', 'foxy-lady', 'ward-eight', 'brown-derby', 'final-ward', 'seelbach', 'red-berry-sour', 'cranberry-sour', 'peach-sour',
    'green-tea-shot', 'lemon-drop-shot', 'buttery-nipple', 'duck-fart', 'washington-apple', 'red-headed-slut', 'purple-hooter', 'woo-woo-shot', 'cement-mixer', 'pickleback', 'three-wise-men', 'brain-hemorrhage', 'jelly-shots', 'prairie-fire', 'surfer-on-acid', 'vegas-bomb', 'chocolate-cake-shot', 'cinnamon-toast-crunch', 'peppermint-patty-shot', 'oatmeal-cookie-shot', 'apple-pie-shot', 'white-gummy-bear-shot', 'kool-aid-shot', 'screaming-orgasm', 'pousse-cafe', 'bumble-bee-shot', 'freddy-kruger', 'two-fifty-two', 'fahrenheit-5000', 'scooby-snack', 'tootsie-roll-shot', 'key-lime-pie-shot', 'pineapple-upside-down-shot', 'root-beer-shot', 'irish-slammer', 'sake-bomb',
  ],
  Canada: ['caesar', 'b-52', 'b-53', 'avalanche',
    'maple-old-fashioned',
    'fireball-shot', 'snake-bite-shot',
  ],
  ...
  'United Kingdom': [
    ...
    'apple-sour', 'hanky-panky', 'blood-and-sand', 'breakfast-martini', 'black-velvet', 'alexander', 'corpse-reviver-1', 'raspberry-sour', 'blackberry-sour',
    'skittle-bomb', 'flaming-lamborghini', 'jam-donut-shot', 'port-and-starboard',
  ],
  Scotland: ['bobby-burns', 'rusty-nail', 'rob-roy', 'scotch-sour',
    'scotch-cobbler', 'whisky-mac',
    'hot-toddy', 'affinity', 'blood-and-sand',
  ],
  ...
  France: [
    ...
    'white-negroni', 'scofflaw', 'french-76',
    'angels-kiss',
  ],
  ...
  Italy: [
    ...
    'milano-torino',
    'sambuca-con-la-mosca', 'limoncello-shot', 'fernet-shot',
  ],
  Spain: [
...
const CITIES = {
  ...
  'kentucky-b-and-b': 'Kentucky', 'maple-old-fashioned': 'Vermont',
  'paper-plane': 'New York', 'gold-rush': 'New York', 'whiskey-smash': 'New York',
  'old-cuban': 'New York', gibson: 'New York', 'naked-and-famous': 'New York',
  siesta: 'New York', 'final-ward': 'New York', 'gin-gin-mule': 'New York',
  'oaxaca-old-fashioned': 'New York', adonis: 'New York',
  'boston-sour': 'Boston', 'ward-eight': 'Boston', 'brown-derby': 'Hollywood',
  'el-diablo': 'Oakland', 'fog-cutter': 'Oakland', seelbach: 'Louisville',
  'kentucky-mule': 'Kentucky', 'gin-basil-smash': 'Hamburg', 'white-negroni': 'Bordeaux',
  'hanky-panky': 'London', 'blood-and-sand': 'London', 'breakfast-martini': 'London',
  'corpse-reviver-1': 'London', 'black-velvet': 'London', alexander: 'London',
  scofflaw: 'Paris', 'french-76': 'Paris', 'milano-torino': 'Milan',
  batanga: 'Jalisco', 'suffering-bastard': 'Cairo', 'cherry-limeade': 'Oklahoma',
  'duck-fart': 'Anchorage', pickleback: 'Brooklyn', 'pousse-cafe': 'New Orleans',
  'vegas-bomb': 'Las Vegas', 'fernet-shot': 'Buenos Aires', moranguito: 'Lisbon',
  kopstootje: 'Amsterdam', 'key-lime-pie-shot': 'Florida Keys',
}
